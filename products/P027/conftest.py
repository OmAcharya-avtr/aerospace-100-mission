...
environment variable below covers the CLI tests, which run ``python -m disturbtorque``
in a child process that does not inherit pytest's sys.path manipulation.
"""
